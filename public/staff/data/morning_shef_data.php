<?php
    /*
    |--------------------------------------------------------------------------
    | MVS Morning Shef App - PHP
    |--------------------------------------------------------------------------
    |
    | This is a description or summary of the purpose and functionality of
    | the code below. It can include any relevant information such as the
    | author, date, and any important notes or warnings.
    |
    | Author: Ivan Nguyen
    | Date: 2024-07-18
    |
    | V 2.1
    | Updated to use PHP DATA API
    |
    */
